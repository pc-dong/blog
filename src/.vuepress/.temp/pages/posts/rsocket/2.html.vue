...
<blockquote>
<p>上一篇博客<RouterLink to="/posts/rsocket/1.html">《通过自定义注解实现REST风格的RSocket CRUD应用》</RouterLink>介绍了在Spring如何开发RSocket应用，由于RSocket是不同于Http的新的通信协议，目前常见的压测工具都没有提供现成性能测试支持。<br>
