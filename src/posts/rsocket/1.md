...
#### RSC命令行工具
[RSC](https://github.com/making/rsc)是类似与curl 命令的RSocket 命令客户端工具， 方便对RSocket API进行调试，具体安装使用方法可以查看[GitHub - RSocket Client CLI (RSC)
](https://github.com/making/rsc)。这里分别给出四种通信模式的命令以及返回示例：
